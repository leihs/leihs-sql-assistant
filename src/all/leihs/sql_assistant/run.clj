...
(def defaults
  {:LEIHS_SQL_HTTP_BASE_URL "http://localhost:3250"
...
(def cli-options
  [["-h" "--help"]
   ["-b" "--http-base-url LEIHS_SQL_HTTP_BASE_URL"
    (str "default: " (:LEIHS_SQL_HTTP_BASE_URL defaults))
    :default (http-url/parse-base-url (env-or-default :LEIHS_SQL_HTTP_BASE_URL))
